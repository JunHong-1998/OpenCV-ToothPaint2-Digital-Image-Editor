...
class WidgetUI(QWidget):
    ...
    def SpinBox(self, flag, min, max, value, width, ODD=None, action=None, height=None):
        if flag:
            if ODD:
                spin = SpinBox()
    ...
    def PushBtnIcon(self, icon, action, border=None, size=None):
        btn = QPushButton(self)
    ...
    def SplashScreen(self):
        splash = QSplashScreen(QPixmap("TP_assets/splashscreen2.png"), Qt.WindowStaysOnTopHint)
